...
library LiquidationLogic {
  ...
  function executeLiquidationCall(
    ...
    debtReserve.updateState(vars.debtReserveCache);  HOOK_liquidation_after_updateState_DBT();
    ...
    );    HOOK_liquidation_after_calculateDebt(vars.userTotalDebt);
    ...
    if (params.receiveAToken) {
      ...
      _burnCollateralATokens(collateralReserve, params, vars);  HOOK_liquidation_after_updateState_COL();
    }
  ...
  function HOOK_liquidation_after_updateState_COL() internal {}
  function HOOK_liquidation_after_calculateDebt(uint256 userTotalDebt) internal {}
}
